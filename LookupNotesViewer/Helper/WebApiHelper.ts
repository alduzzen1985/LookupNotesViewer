...
export class WebApiHelper {
    ...
    GetRecordByIdEntityAndSelectFields(guid: string, entityType: string, successCallback: (result: any) => any, errorCallBack: (result: string) => any, ...selectFields: string[]): ComponentFramework.WebApi.Entity {
